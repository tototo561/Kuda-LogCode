...
| AOP hardwiring | AspectJ 1.9.7 pointcut on every public method |
| ELK | Elasticsearch 8.10, Logstash 8.10, Kibana 8.10 |
| Loki | Loki 2.9, Grafana 10.1 |

## Code Generation

| Baseline | Version | Notes |
|----------|---------|-------|
| Manual conversion | N/A | Human developer, ~50 loc/h |
| ANTLR4 | 4.13.0 | Java + Python grammars |
